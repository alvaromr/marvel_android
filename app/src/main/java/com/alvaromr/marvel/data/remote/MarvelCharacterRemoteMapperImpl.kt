...
@Singleton
class MarvelCharacterRemoteMapperImpl @Inject constructor(
) : MarvelCharacterRemoteMapper {

    override fun toModel(dtoList: List<MarvelCharacterApiDto>) = dtoList.map { it.toModel() }
